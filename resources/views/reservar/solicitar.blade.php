...
@section('content')
    ...
    <table class="table ">
       ...
       <tr><th>Descripcion <td>{{$equipos->equ_descripcion}}</td></tr>
        ...
        <tr><th>Video<td>{{$equipos->hardware->hard_disco}}</td></tr>
     ...
     {!! Form::submit('Generar reserva',['class'=>'btn btn-primary']) !!} <a href="buscarEquipo" class="btn btn-success">Seleccionar otro</a>
     {!!Form::close()!!}
